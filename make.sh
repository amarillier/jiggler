...
setIcon.sh KrankyBearBeret.png bin/jiggler-MacOSARM64
setIcon.sh KrankyBearBeret.png bin/jiggler-MacOSAMD64
setIcon.sh KrankyBearBeret.png bin/jiggler.exe